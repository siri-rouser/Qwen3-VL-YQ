import evaluate
from transformers import AutoConfig, Qwen3VLForConditionalGeneration, AutoProcessor, AutoModelForImageTextToText, GenerationConfig,Qwen3VLConfig
import torch
import argparse
...
if __name__ == "__main__":
    ...
    training_data_path = "/workspace/QWEN3-VL/datasets/CARMEL_VAD/carmel_vad_cat_training_with_system_5cat_mini.json"
    model_dir = "/output/sft_qwen3_4b_carmel_vad3"
    ...
    processor = AutoProcessor.from_pretrained("/output/sft_qwen3_4b_carmel_vad3")
    # processor = AutoProcessor.from_pretrained("Qwen/Qwen3-VL-4B-Instruct")

    eval_main(model=model, processor=processor, data_path=training_data_path, evaluation_category=args.evaluation_category, output_path=args.output_path)